...
export function generateMedicalReport(result: PredictionData, formData?: SymptomFormData) {
  ...
  doc.setFontSize(6.5);
  const disclaimer =
    "This report is generated by an ML ensemble (Gradient Boosting + Logistic Regression) validated by AI clinical reasoning. It is for informational and educational purposes only and does not constitute medical advice, diagnosis, or treatment. Always consult a qualified healthcare professional for proper medical evaluation. This report is intended to support—not replace—clinical decision making.";
